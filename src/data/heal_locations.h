static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 24, 24},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 14, 16},
    ...
    [HEAL_LOCATION_OLDALE_TOWN_G - 1] = {MAP_GROUP(OLDALE_TOWN_G), MAP_NUM(OLDALE_TOWN_G), 10, 10},
};
